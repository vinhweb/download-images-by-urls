...
const products: TProduct[] = [
	{
		name: 'Webcam Logitech MX BRIO Ultra HD 4K - Hội họp & truyền trực tuyến, Mic kép giảm ồn, Show Mode, USB-C',
	...
	{
		name: 'Chuột Bluetooth Logitech M350s Pebble 2 Silent - Mỏng nhẹ, Nút tùy chỉnh, Easy-Switch, 4000DPI',
	...
	{
		name: 'Combo Chuột & Bàn phím Signature Slim Logitech MK950 - Gõ và Nhấp yên tĩnh, Đa thiết bị, Bluetooth 5.0',
	...
	{
		name: 'Combo Bàn phím Logitech K650 & Chuột Logitech M650 - Bluetooth, USB Bolt',
	...
	{
		name: 'Bàn phím cơ không dây bluetooth | USB Logitech POP KEYS - phím emoji có thể tùy chỉnh',
	...
	{
		name: 'Chuột không dây Bluetooth Logitech MX Master 3s – Yên tĩnh, 8K DPI, Cuộn siêu nhanh, sạc USB-C, Win | Mac',
	...
	{
		name: 'Bàn phím không dây Logitech MX Keys S - Low Profile yên tĩnh, Đèn nền, Bluetooth, Sạc USB-C',
		image_url: 'https://down-vn.img.susercontent.com/file/vn-11134207-7qukw-livh4fp1sp8yf7',
	...
	{
		name: 'Bàn phím không dây Bluetooth Logitech MX Keys Mini - Nhỏ gọn, Phím tắt thông minh, Có bản cho Mac',
	...
	{
		name: 'Chuột game có dây Logitech G502 Hero - Cảm biến Hero 25k, RGB, 11 nút lập trình',
	...
	{
		name: 'Tai nghe game không dây Lightspeed Logitech G535 - Nhẹ, âm thanh nổi PC, PS4, PS5',
	...
	{
		name: 'Tai nghe gaming không dây Logitech G735 Aurora - Bluetooth & Lightspeed, RGB, PC, Mac',
	...
	{
		name: '[Version 2] Bàn phím gaming Logitech G PRO X TLK Lightspeed - RGB, Switch GX Tactile',
	...
	{
		name: 'Bàn phím cơ gaming Logitech G512 GX RGB - 3 loại phím cơ GX Switch, cổng USB 2.0',
	...
	{
		name: 'Bàn di chuột Logitech Mouse Pad Studio Series - Đế chống trượt, lướt dễ dàng, chống đổ tràn',
